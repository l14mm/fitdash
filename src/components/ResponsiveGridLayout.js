    ...
    return (
      <div>
        ...
        {this.props.children}
          ...
          {/* <div key="1" data-grid={{ w: 2, h: 3, x: 0, y: 0, minW: 2, minH: 3 }}>
            <Paper style={{height:'100%'}}>1</Paper>
          </div>
          <div key="2" data-grid={{ w: 2, h: 3, x: 2, y: 0, minW: 2, minH: 3 }}>
            <Paper style={{height:'100%'}}>2</Paper>
          </div>
          <div key="3" data-grid={{ w: 2, h: 3, x: 4, y: 0, minW: 2, minH: 3 }}>
            <Paper style={{height:'100%'}}>3</Paper>
          </div>
          <div key="4" data-grid={{ w: 2, h: 3, x: 6, y: 0, minW: 2, minH: 3 }}>
            <Paper style={{height:'100%'}}>4</Paper>
          </div>
          <div key="5" data-grid={{ w: 2, h: 3, x: 8, y: 0, minW: 2, minH: 3 }}>
            <Paper style={{height:'100%'}}>5</Paper>
          </div> */}
        </ResponsiveReactGridLayout>
      </div>
    );
